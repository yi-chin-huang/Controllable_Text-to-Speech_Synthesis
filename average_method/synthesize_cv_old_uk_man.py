...
if __name__ == '__main__':
    ...
    num_generated = 0
    # input_voice_file = "/home/dataset/CommonVoice/cv-corpus-17.0-2024-03-15/en/clips/common_voice_en_17813344.mp3" # old UK man A
    input_voice_file = "/home/dataset/CommonVoice/cv-corpus-17.0-2024-03-15/en/clips/common_voice_en_39645706.mp3" # old UK man B
    ...
    for (i, average_embed) in enumerate(average_embeds):
        try:
            ...
            filename = "synthesis_audio/common_voice/old_uk_manB/" + note_dict[i] + "_changed.wav"
